...
require (
	...
	github.com/googleapis/gax-go/v2 v2.23.0 // indirect; @grafana/grafana-backend-group
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.68.0 // indirect; @grafana/plugins-platform-backend
